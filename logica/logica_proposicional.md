...
|  $A$   | $\neg A$ | $\hspace{5px}$ | $A$ | $\neg A$ | $\hspace{5px}$ | $A$ | $\neg A$ | 
|:------:|:--------:|:--------------:|:---:|:--------:|:--------------:|:---:|:--------:|
| $\top$ |  $\bot$  | $\hspace{5px}$ |  V  |    F     | $\hspace{5px}$ |  1  |    0     | 
| $\bot$ |  $\top$  | $\hspace{5px}$ |  F  |    V     | $\hspace{5px}$ |  0  |    1     | 
...
- "Chove somente se molha a rua." <br> ↳ $C:$ "Chove" | $M:$ "molha a rua." $\hspace{5px} \therefore \hspace{5px} M \implies C$. <br> <br>
- "Se o chão está molhado então choveu e não há cobertura." <br> ↳ $A:$ "o chão está molhado" | $B:$ "choveu" | $C:$ "há cobertura." $\hspace{5px} \therefore \hspace{5px} A \implies B \land \neg C$. <br> <br>
- "Você vai à praia ou não gosta de biscoito." <br> ↳ $V:$ "Você vai à praia" | $G:$ "Você gosta de biscoito" $\hspace{5px} \therefore \hspace{5px} V \lor \neg G$. <br> <br>
- "T é um triângulo se e somente se T é um polígono de 3 lados." <br> ↳ $E:$ "T é um triângulo" | $P:$ "T é um polígono de 3 lados" $\hspace{5px} \therefore \hspace{5px} E \iff P$. <br> <br>
- "T é um triângulo se T é um polígono de 3 lados." <br> ↳ $E:$ "T é um triângulo" | $P:$ "T é um polígono de 3 lados" $\hspace{5px} \therefore \hspace{5px} P \implies E$. <br> <br>
- "Se Denis jogar na loteria, então ele ficará rico ou desiludido." <br> ↳ $L:$ "Denis joga na loteria" | $R:$ "Denis fica rico" | $D:$ "Denis fica desiludido" $\hspace{5px} \therefore \hspace{5px} L \implies R \lor D$. <br> <br>
