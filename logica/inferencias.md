...
$$
\frac{P \hspace{50px} P \implies Q}{\therefore Q} \hspace{25px}\text{(MP)} 
$$
...
- O texto à direita, no caso "MP", é o acrônimo da regra (nesse caso, de "Modus Ponens"), mas o espaço à direita também pode ser usado para indicar restrições como “$\alpha$ não ocorre em $\Delta$” ou condições de escopo de variáveis

A seguir, a tabela apresenta todas as regras de inferência:

|                                                     Regra                                                      |                      Tautologia associada                       |        Nome da regra        | Explicação                                                                                                                                                                                                                                                                           |
|:--------------------------------------------------------------------------------------------------------------:|:---------------------------------------------------------------:|:---------------------------:|:-------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
|       $$\frac{p}{\therefore p \lor q} \hspace{25px}(\text{I} \,\lor)$$ (Aplicável à $\land, \neg, \lor$)       |                     $$p \implies p \lor q$$                     |    Adição ou *Inclusão*     | Se uma hipótese é verdadeira, <br> a disjunção também é                                                                                                                                                                                                                              |
|         $$\frac{p \land q}{\therefore p} \hspace{25px}(\text{E} \,\land)$$ (Aplicável à $\land, \neg$)         |                   $$(p \land q) \implies p$$                    | Simplificação ou *Exclusão* | Se a conjunção de hipóteses é verdade, <br> a conclusão também é                                                                                                                                                                                                                     |
